...
// NTC Sensörler
NTCSensor ntc1(NTC1_PIN, 3.3f, 9470.0f, 4780.0f, 3950.0f); // Araç 1
 ...
 */
void sendJsonData() {
     float temp = ntc1.readTemperature();
    ...
    float acceleration = ay * 9.81f; // g -> m/s²

    // 4. SICAKLIK MANTIĞI (Senin isteğin: 2 Araç, 1 Batarya)
    //loat t_vehicle1 = ntc1.readTemperature();
